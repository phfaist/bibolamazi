...
class TestWorks(unittest.TestCase):
    ...
    def test_protect_names(self):
        ...
        filt = FixesFilter(
            ...
            # whitespace
                 protect_names="Einstein,Maxwell, , Landauer ,Podolsky,Rosen, Hawking, Newton,i.i.d.,R{\\'{e}}nyi,Neumann,Szilard,Bell,I,II,XIV",
        )
    ...
    def test_rest(self):
        ...
        filt = FixesFilter(
                 ...
                 protect_names='Einstein,Maxwell,Landauer,Newton,Neumann,Szilard,Bell,I,II,XIV',
