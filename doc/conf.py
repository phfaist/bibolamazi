# -*- coding: utf-8 -*-
#
# Bibolamazi documentation build configuration file, created by
...
#import bibolamazi_3rdparty  # no, assume installed via pip
...
release = bibolamaziversion.version_str
...
latex_documents = [
  ('index', 'Bibolamazi.tex', u'Bibolamazi Documentation',
...
man_pages = [
    ('index', 'bibolamazi', u'Bibolamazi Documentation',
     [u'Philippe Faist'], 1)
]
...
texinfo_documents = [
  ('index', 'Bibolamazi', u'Bibolamazi Documentation',
   u'Philippe Faist', 'Bibolamazi', 'One line description of project.',
   'Miscellaneous'),
]
